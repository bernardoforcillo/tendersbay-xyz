...
const SOCIALS: Social[] = [
  { name: 'GitHub', href: 'https://github.com/bernardoforcillo/tendersbay-xyz', icon: 'github' },
  { name: 'LinkedIn', href: 'https://www.linkedin.com/in/bernardoforcillo/', icon: 'linkedin' },
  { name: 'X', href: 'https://x.com/bernaforcillo', icon: 'twitter' },
];
